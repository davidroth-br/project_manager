package com.montrealcollege.projectmanager.config;
...
@ComponentScan({"com.montrealcollege.projectmanager.config"})
public class HibernateConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() throws SQLException {
        ...
        sessionFactory.setPackagesToScan("com.montrealcollege.projectmanager.model");
    ...
    public DataSource dataSourceOracle() throws SQLException {
        ...
        dataSource.setUser("projman");
        dataSource.setPassword("projman");
        return dataSource;
    }
